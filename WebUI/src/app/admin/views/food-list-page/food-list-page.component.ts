...
export class FoodListPageComponent implements OnInit {
  ...
  getFoodList() {
    ...
    this.foodService.getList(this.pagination).subscribe((listFoods: IFoodList | any) => {
  ...
  selectItem(food: IFood) {
    console.log(food)
    this.mainIngredientDetailService.getList(food.id).subscribe((data: IMainIngredientDetail[] | any) => {
